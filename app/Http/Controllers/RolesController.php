...
class RolesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:role-create', ['only' => ['create','store', 'actualizarEstado']]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('roles.index')->with('success','Roles creados satisfactoriamente.');
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('roles.index')->with('success','Roles eliminados satisfactoriamente.');
        } catch (\Throwable $th) {
            DB::rollback();
