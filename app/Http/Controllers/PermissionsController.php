...
class PermissionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('permissions.index')->with('success','Permisos creados satisfactoriamente.');
        } catch (\Throwable $th) {
            DB::rollback();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('permissions.index')->with('success','Permisos eliminados satisfactoriamente.');
        } catch (\Throwable $th) {
            DB::rollback();
