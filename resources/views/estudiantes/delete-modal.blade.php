        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('estudiante-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="estudiante-delete-form" method="POST" action="{{ route('estudiantes.destroy', ['estudiante' => $estudiante->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
