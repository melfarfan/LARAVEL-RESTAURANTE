        ...
        <div class="card-body">
            <form method="POST" action="{{route('roles.update', ['role' => $role->id])}}">
                ...
                <div class="form-group row">
                    ...
                    {{-- Guard Name --}}
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <strong>Guard Name: </strong><span style="color:red;">*</span></label>
                    ...
                    <div class="col-sm-12 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="checkbox" name="check-all" class="form-contol" id="checkAllPermissions" {{ (count($permissions) == count($role->permissions->pluck('id')->toArray())) ? 'checked' : '' }}/> Todos
                        <div class="row">
                            <div class="col-lg-12">
                ...
                {{-- Save Button --}}
                <button type="submit" class="btn btn-sm btn-outline-success btn-lg btn-block">
                    ACTUALIZAR ROL
                </button>
