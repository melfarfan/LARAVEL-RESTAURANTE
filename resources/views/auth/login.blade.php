...
<div class="row justify-content-center">
    ...
    <div class="text-center mt-5">
        <h1 class="text-white">Panel de Gestión de Pizzería Antonella</h1>
    </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-block">
                        <img src="{!! asset('images/logopizzas.png') !!}" alt="Logo" class="img-fluid">
                    </div>
                    <div class="col-lg-6">
                        <div class="p-5">
    ...
    <div class="text-center mt-5">
        <h6 class="text-white">Desarrollado Por : <a class="text-white" href="">Mel Farfán</a></h6>
    </div>
