		...
		<div class="card shadow mb-4">
			...
			<form method="POST"
					...
					<div class="form-group row">
						...
						<div class="col-sm-6 mb-3 mt-3 mb-sm-0">
							...
							<input type="text"
								...
								id="first_name" placeholder="nombres" name="first_name"
						...
						{{-- Last Name --}}
						<div class="col-sm-6 mb-3 mt-3 mb-sm-0">
							<span style="color:red;">*</span>Apellidos:</label>
							<input type="text"
						...
						{{-- Email --}}
						<div class="col-sm-6 mb-3 mt-3 mb-sm-0">
							<span style="color:red;">*</span>Correo Electr&oacute;nico:</label>
							<input type="email"
								class="form-control form-control-user @error('email') is-invalid @enderror"
								id="exampleEmail" placeholder="Correo Electr&oacute;nico" name="email"
						...
						{{-- Mobile Number --}}
						<div class="col-sm-6 mb-3 mt-3 mb-sm-0">
							<span style="color:red;">*</span>N&uacute;mero de Celular:</label>
							<input type="text"
								class="form-control form-control-user @error('mobile_number') is-invalid @enderror"
								id="exampleMobile" placeholder="N&uacute;mero de Celular"
								name="mobile_number"
						...
						<div class="col-sm-6 mb-3 mt-3 mb-sm-0">
							...
							<select
								class="form-control form-control-user @error('role_id') is-invalid @enderror"
								name="role_id">
						...
						{{-- Password --}}
						<div class="col-sm-6 mb-3 mt-3 mb-sm-0">
							<span style="color:red;">*</span>Contrase&ntilde;a:</label>
							<input type="password"
								class="form-control form-control-user @error('password') is-invalid @enderror"
								id="exampleInputPassword" placeholder="Contrase&ntilde;a" name="password">
				...
				<div class="card-footer">
					<button type="submit"
						class="btn btn-outline-success btn-user float-right mb-3"><i
