...
@section('title', 'Actualizar Expedición')
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary"><i class="fas fa-user-plus"></i> ACTUALIZAR EXPEDICI&Oacute;N</h6>
        </div>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 mb-3 mt-3">
                        <label for="descripcion"><strong>Descrici&oacute;n:</strong></label>
                        <input
                            type="text"
